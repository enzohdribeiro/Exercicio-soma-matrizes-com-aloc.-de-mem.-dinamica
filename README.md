...
* **liberaMatriz**: Garante a limpeza correta da memória, evitando vazamentos (memory leaks).
...
* **Nota de Memória**: Realiza-se a boa prática de liberação de memória (free) para cada linha e para o ponteiro principal ao final do uso e checagem para possíveis retornos NULL da função malloc.
